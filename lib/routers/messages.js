 ...
 * @async
 */
exports.Messages.prototype.getRooms = function(company, callback) {
  debug('running request');
  this.api.client.get('messages/v3/' + company + '/rooms', {}, callback);
}
...
exports.Messages.prototype.getRoomDetails = function(company, roomId, params, callback) {
  params = params || {};
  debug('running request');
  this.api.client.get('message/v3/' + company + '/rooms/' + roomId, params, callback);
}
...
exports.Messages.prototype.getRoomByOffer = function(company, offerId, params, callback) {
  params = params || {};
  debug('running request');
  this.api.client.get('message/v3/' + company + '/rooms/offers/' + offerId, params, callback);
}
...
exports.Messages.prototype.getRoomByApplication = function(company, applicationId, params, callback) {
  params = params || {};
  debug('running request');
  this.api.client.get('message/v3/' + company + '/rooms/applications/' + applicationId, params, callback);
}
...
exports.Messages.prototype.getRoomByContract = function(company, contractId, params, callback) {
  params = params || {};
  debug('running request');
  this.api.client.get('message/v3/' + company + '/rooms/contracts/' + contractId, params, callback);
}
...
exports.Messages.prototype.createRoom = function(company, params, callback) {
  params = params || {};
  debug('running request');
  this.api.client.post('message/v3/' + company + '/rooms', params, callback);
}
...
exports.Messages.prototype.sendMessageToRoom = function(company, roomId, params, callback) {
  params = params || {};
  debug('running request');
  this.api.client.post('message/v3/' + company + '/rooms/' + roomId + '/stories', params, callback);
}
...
exports.Messages.prototype.updateRoomSettings = function(company, roomId, username, params, callback) {
  params = params || {};
  debug('running request');
  this.api.client.put('message/v3/' + company + '/rooms/' + roomId + '/users/' + username, params, callback);
}
...
exports.Messages.prototype.updateRoomMetadata = function(company, roomId, params, callback) {
  params = params || {};
  debug('running request');
  this.api.client.put('message/v3/' + company + '/rooms/' + roomId, params, callback);
}
